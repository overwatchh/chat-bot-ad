...
Answer 2 questions to get a free horoscope.`,
  ...
  },
  {
    ...
    message: `This sign will have a financial revolution in the nearest future. Financial fortune is now at the bottom. You deny yourself a lot of things, debts are haunting you. You are determined to push money and fortune away out of your life.`,
  ...
  },
  {
    ...
    message: `I can clearly see that you will have the opportunity to change the chosen vector in August. This will be a favourable period for changing your life, from a bad luck to a good one, until the end of your life.`,
    trigger: 'bot_say_prediction_5',
    asMessage: true,
  },
  {
    id: 'bot_say_prediction_5',
    message: `Nothing in your life happens by chance. The Aries sign is very susceptible to bad energy. You need to protect yourself and attract money luck.`,
  ...
  },
  {
    ...
    message: `I will make a special Shiva Lucky Charm for you and empower it with magic force, which will clear you of dark energy`,
    trigger: 'bot_say_prediction_11',
    asMessage: true,
  },
  {
    id: 'bot_say_prediction_11',
    message: `The Shiva Lucky Charm looks like this`,
  ...
  },
  {
    ...
    message: `Why do you need this Shiva Lucky Charm?`,
    trigger: 'bot_say_prediction_13',
    asMessage: true,
  },
  {
    id: 'bot_say_prediction_13',
    message: `This Shiva Lucky Charm will change your life dramatically in a month - all your debts will be gone. Money will flow to you from various sources, and you will be able to forget about financial failures and savings for the rest of your life`,
    trigger: 'bot_say_prediction_14',
    asMessage: true,
  },
  {
    id: 'bot_say_prediction_14',
    message: `I always try to help people solve their problems, and I never try to profit from it. That is why, until 30 May inclusive, you get a 90% discount on the Shiva Lucky Charm. The price for you is only 2599 ₱ + Free shipping nationwide`,
    trigger: 'bot_say_prediction_15',
    asMessage: true,
  },
  {
    id: 'bot_say_prediction_15',
    message: `You can order Shiva Lucky Charm wright now! Just put your name and phone in form and your life will change. I promise!`,
